...
<%@ include file="../../common/header.jsp" %>
					...
					<div class="mypage_content">
						...
						<div class="reserv_wrap mypage-reservation-info">
							<div class="reserv_box accepted">
								...
								<a href="/mypage/reservation/75396007">
									<div class="reserv_info">
										<!-- =============================== 숙소 체크인 / 체크아웃 ============================================-->
										<div class="day">2023.11.09 ~ 2023.11.10 (1 박)</div>
										<!-- =============================== 예약 인원 ============================================-->
										<div class="option">
											성인 2명<br>
										</div>
									</div> <!-- =============================== 가격 & view ============================================-->
									<div class="price">₩가격</div> <br>
									<button type="button" class="btn_reserv_detail">예약 상세
										확인</button>
								</a>
							</div>
						</div>
	...
	<script src="/_next/static/chunks/7637-a33ca78fac884b5d.js"></script>
	...
	<noscript>
		<img height="1" width="1" style="display: none"
			src="https://www.facebook.com/tr?id=1800125330267035&amp;ev=PageView&amp;noscript=1">
	</noscript>
	<script type="text/javascript" id="">fbq("track", "Login");</script>
	<script type="text/javascript" id="" charset="UTF-8"
		src="//t1.daumcdn.net/kas/static/kp.js"></script>
	<script type="text/javascript" id="gtm-scroll-tracking-for-spa">(function (b) {
	...
	<script
		src="/_next/static/chunks/pages/journal/videos-a6cbcbcc971712c5.js"></script>
	...
	<script
		src="/_next/static/chunks/pages/4-point-approach-abf9f68f467ae115.js"></script>
	<script src="/_next/static/chunks/4824-06b75777f13ab866.js"></script>
	<script
		src="/_next/static/chunks/pages/mypage/reservation-a01571262cb0ce25.js"></script>
	<script
		src="/_next/static/chunks/pages/mypage/reservation/cancel-5c7691f3b5a91f8a.js"></script>
	<script
		src="/_next/static/chunks/pages/mypage/offlinepass-5b8f54ac0f9ae125.js"></script>
	<script
		src="/_next/static/chunks/pages/mypage/likestay-e179e5a70e0c8a96.js"></script>
	...
	<script
		src="/_next/static/chunks/pages/mypage/account/edit-86e3367dc08cadf9.js"></script>
	...
	<script
		src="/_next/static/chunks/pages/findstay/%5Bidentifier%5D-88b0f50c00a4bb4e.js"></script>
	<script src="/_next/static/chunks/4144-177a15d333506c8a.js"></script>
	<script
		src="/_next/static/chunks/pages/mypage/reservation/%5Bid%5D-885f622593389ff1.js"></script>
	<script type="text/javascript" id="" charset="UTF-8"
		src="//t1.daumcdn.net/kas/static/kp.js"></script>
	<script type="text/javascript" id="gtm-scroll-tracking-for-spa">(function (b) {
                    function d() { if (!(this instanceof d)) return new d; this._config = {}; this._tracked = []; this._eventName = ""; this._tracking = this._tracking.bind(this); this._listenerAdded = !1 } d.prototype._tracking = function () {
	...
	<script type="text/javascript" id="">if (!wcs_add) var wcs_add = {}; wcs_add.wa = "s_4371e2020dab"; if (!_nasa) var _nasa = {}; window.wcs && (wcs.inflow(), wcs_do(_nasa));</script>
	<script
		src="/_next/static/chunks/pages/journal/picks/%5Bidentifier%5D-4da3eacb7772e1da.js"></script>
	<script
	...
	<div
		...
		<div
			...
			<iframe title="reCAPTCHA&nbsp;보안문자 2분 후 만료"
				src="https://www.google.com/recaptcha/api2/bframe?hl=ko&amp;v=iRvKkcsnpNcOYYwhqaQxPITz&amp;k=6LdeeBcnAAAAAMqxrJXRJqQp9ebzdrjCSY28jINH"
				name="c-xgmuifblqvhr" frameborder="0" scrolling="no"
